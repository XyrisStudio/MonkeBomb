...
void UATPCCameraComponent::BeginPlay()
{
	...
	OldCameraMode = GetCurrentCameraMode();
	SetRelativeTransform(OldCameraMode->CameraRelativeLocation);
...
{
	if(GetCurrentCameraMode()->CameraRelativeLocation.GetLocation() != OldCameraMode->CameraRelativeLocation.GetLocation())
	{
		SetRelativeLocation(GetCurrentCameraMode()->CameraRelativeLocation.GetLocation());
	}

	if(GetCurrentCameraMode()->CameraRelativeLocation.GetRotation() != OldCameraMode->CameraRelativeLocation.GetRotation())
	{
		SetRelativeRotation(GetCurrentCameraMode()->CameraRelativeLocation.GetRotation());
	}
